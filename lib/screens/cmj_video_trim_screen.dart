...
/// "Analyze Jump from Here" to extract a 2-second window.
class CmjVideoTrimScreen extends StatefulWidget {
  const CmjVideoTrimScreen({super.key});

  @override
  State<CmjVideoTrimScreen> createState() => _CmjVideoTrimScreenState();
}

class _CmjVideoTrimScreenState extends State<CmjVideoTrimScreen> {
